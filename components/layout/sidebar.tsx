...
import { navSections } from "@/lib/nav/navigation-customer";
    ...
    <aside className="flex h-screen w-64 shrink-0 flex-col border-r bg-card/40">
      <div className="flex h-14 shrink-0 items-center gap-2 border-b px-4">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-xs text-muted-foreground leading-tight">Online Banking</span>
        </div>
      </div>
