      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sign in to view your accounts, transactions, and profile settings.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-center text-xs text-muted-foreground">
              You will be redirected to Minab sign-in to enter your credentials. Additional
              verification may be required to protect your account.
            </p>
          </CardContent>
        </Card>
        <p className="text-center text-xs text-muted-foreground">
