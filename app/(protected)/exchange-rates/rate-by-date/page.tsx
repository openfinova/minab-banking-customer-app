...
export default function ExchangeRateByDatePage() {
  return (
...
function Content() {
  ...
  const load = async () => {
    try {
      const r = await exchangeApi.getHistoricalRate({
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Choose pair, rate type, and rate date.</CardDescription>
        </CardHeader>
