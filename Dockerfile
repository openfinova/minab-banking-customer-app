...
ARG OIDC_CLIENT_ID=customer-portal
ARG OIDC_CLIENT_SECRET=customer-portal-secret
ARG OIDC_REDIRECT_URI=http://localhost:3001/api/auth/callback
ARG OIDC_POST_LOGOUT_REDIRECT_URI=http://localhost:3001/login
ARG OIDC_SCOPES="openid profile email offline_access banking.customer"
ARG SESSION_SECRET=local-dev-session-secret-change-me-32chars
ARG SESSION_IDLE_MS=900000
ARG SESSION_ALLOW_REFRESH=true
...
ENV SESSION_ALLOW_REFRESH=$SESSION_ALLOW_REFRESH
